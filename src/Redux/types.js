...
export const SORT_MEMBERS_BY_NAME = "SORT_MEMBERS_BY_NAME";
export const SORT_MEMBERS_BY_ROUNDS = "SORT_MEMBERS_BY_ROUNDS";
...
export const SORT_ROUND_BY_NAME = "SORT_ROUND_BY_NAME";
export const SORT_ROUND_BY_SCORE = "SORT_ROUND_BY_SCORE";

// STANDINGS TYPES
export const GET_STANDINGS_FORMATS_LOADING = "GET_STANDINGS_FORMATS_LOADING";
export const GET_STANDINGS_FORMATS_SUCCESS = "GET_STANDINGS_FORMATS_SUCCESS";
export const GET_STANDINGS_FORMATS_FAILED = "GET_STANDINGS_FORMATS_FAILED";
export const GET_STANDINGS_BY_LEAGUE_ID_LOADING =
  "GET_STANDINGS_BY_LEAGUE_ID_LOADING";
export const GET_STANDINGS_BY_LEAGUE_ID_SUCCESS =
  "GET_STANDINGS_BY_LEAGUE_ID_SUCCESS";
export const GET_STANDINGS_BY_LEAGUE_ID_FAILED =
  "GET_STANDINGS_BY_LEAGUE_ID_FAILED";
export const GET_STANDINGS_FORMAT_BY_LEAGUE_ID_LOADING =
  "GET_STANDINGS_FORMAT_BY_LEAGUE_ID_LOADING";
export const GET_STANDINGS_FORMAT_BY_LEAGUE_ID_SUCCESS =
  "GET_STANDINGS_FORMAT_BY_LEAGUE_ID_SUCCESS";
export const GET_STANDINGS_FORMAT_BY_LEAGUE_ID_FAILED =
  "GET_STANDINGS_FORMAT_BY_LEAGUE_ID_FAILED";
export const CONNECT_FORMAT_TO_LEAGUE_LOADING =
  "CONNECT_FORMAT_TO_LEAGUE_LOADING";
export const CONNECT_FORMAT_TO_LEAGUE_SUCCESS =
  "CONNECT_FORMAT_TO_LEAGUE_SUCCESS";
export const CONNECT_FORMAT_TO_LEAGUE_FAILED =
  "CONNECT_FORMAT_TO_LEAGUE_FAILED";
export const UPDATE_LEAGUE_FORMAT_LOADING = "UPDATE_LEAGUE_FORMAT_LOADING";
export const UPDATE_LEAGUE_FORMAT_SUCCESS = "UPDATE_LEAGUE_FORMAT_SUCCESS";
export const UPDATE_LEAGUE_FORMAT_FAILED = "UPDATE_LEAGUE_FORMAT_FAILED";
export const DELETE_LEAGUE_FORMAT_LOADING = "DELETE_LEAGUE_FORMAT_LOADING";
export const DELETE_LEAGUE_FORMAT_SUCCESS = "DELETE_LEAGUE_FORMAT_SUCCESS";
export const DELETE_LEAGUE_FORMAT_FAILED = "DELETE_LEAGUE_FORMAT_FAILED";
export const SORT_STANDINGS_BY_NAME = "SORT_STANDINGS_BY_NAME";
export const SORT_STANDINGS_BY_TOTAL = "SORT_STANDINGS_BY_TOTAL";
export const SORT_STANDINGS_BY_AVERAGE = "SORT_STANDINGS_BY_AVERAGE";
export const SORT_STANDINGS_BY_ROUND = "SORT_STANDINGS_BY_ROUND";

// CLEAR TYPES

export const CLEAR_USER_LEAGUES = "CLEAR_USER_LEAGUES";
...
export const CLEAR_STANDINGS_RESULTS = "CLEAR_STANDINGS_RESULTS";
export const CLEAR_STANDINGS_FORMATS = "CLEAR_STANDINGS_FORMATS";
export const CLEAR_STANDINGS_LEAGUE_FORMAT = "CLEAR_STANDINGS_LEAGUE_FORMAT";
